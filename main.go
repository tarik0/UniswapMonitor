...
import (
	...
	"PoolHelper/src3/cache/newcache/uniswap"
	"PoolHelper/src3/multicaller/generic"
	uniswap_v3 "PoolHelper/src3/pool/uniswap"
	"context"
	"fmt"
...
func main() {
	_c := uniswap.NewV2Cache()
	__c := uniswap.NewV3Cache()
	__c.AddToken()
	...
	fmt.Printf("Synced newcache to block %d\n", block.Number().Uint64())
