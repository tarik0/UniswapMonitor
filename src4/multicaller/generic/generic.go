...
type Multicaller multicaller.Multicaller[Call3, Result]
...
func NewMulticall(contract common.Address, callCost uint64, maxGas uint64, cAbi abi.ABI, client multicaller.ClientDispatcher) *MulticallContract {
